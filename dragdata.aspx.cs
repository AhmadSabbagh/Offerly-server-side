...
{
    public partial class dragdata : System.Web.UI.Page
    {
        ...
        int id = int.Parse(DropDownList2.SelectedValue);
            SqlDataAdapter Da = new SqlDataAdapter("select email,customer.phone,name   from customer,agent,flow where customerf_id= customer_id and agentf_id=agent_id and agent_id="+ id +" ", dal.dbc.conn);
            Da.Fill(Dt);
        ...
        {
            int id = int.Parse(DropDownList2.SelectedValue);
            SqlDataAdapter Da = new SqlDataAdapter("select email,phone,name as name_agent   from customer,agent,flow where customerf_id= customer_id and agentf_id=agent_id and agent_id=" + id + " ", dal.dbc.conn);
            Da.Fill(Dt);
        ...
        {
            int id = int.Parse(DropDownList2.SelectedValue);
            SqlDataAdapter Da = new SqlDataAdapter("select email,name as name_agent   from customer,agent,flow where customerf_id= customer_id and agentf_id=agent_id and agent_id=" + id + " ", dal.dbc.conn);
            Da.Fill(Dt);
