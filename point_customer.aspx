<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="point_customer.aspx.cs" Inherits="orgproject.point_customer" %>
  ...
  transform: translateY(4px);
    ...
    <form id="form1" runat="server">
        <table style="width: 100%">
            <tr>
                <td>
                    <asp:Button ID="Button3" runat="server" OnClick="Button3_Click" Text="&#1575;&#1590;&#1575;&#1601;&#1577; &#1593;&#1585;&#1608;&#1590;" />
                </td>
                <td>
