<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="map.aspx.cs" Inherits="orgproject.map" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        <asp:Button ID="Button1" runat="server" Text="تثبيت الموقع" OnClick="Button1_Click" CssClass="button" />
